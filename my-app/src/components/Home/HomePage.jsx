...
export default function HomePage() {
  ...
  // 1. Pehle pata karo ki current shape ke liye data kahan hai
  const currentShapeData = selectedProng?.shapeMap?.[selectedDiamond?.name];

  // 2. Ab check karo: 
  // Pehle shape ke andar ka offsetY dekho, 
  // agar wahan nahi hai toh main object ka offsetY dekho, 
  // agar wahan bhi nahi hai toh default 1.72 rakho.
  const currentYDivisor = currentShapeData?.offsetY || selectedProng?.offsetY || 1.72;
        ...
        <div className="flex w-full lg:w-[70%] xl:w-[75%] 2xl:w-[80%] h-[35vh] sm:h-[40vh] lg:h-full items-center justify-center">
          <div className="w-full h-full">
            <RingModel
              ...
              // Yahan updated variables pass karein:
        ...
        <div className="flex w-full lg:w-[30%] xl:w-[25%] 2xl:w-[20%] bg-transparent flex-col h-[50vh] lg:h-full">
          ...
          <div className="flex-1 overflow-y-auto pb-20">
            <div className="p-3 sm:p-4 md:p-6">
              ...
              {activeTab === "diamonds" && (
                <>
                  {/* === 1. Select Your Stones (Carat + Diamond Shapes + Load More) === */}
                  <PremiumAccordion
